...
import { createInscricao, getAllInscricoes } from '../../services/inscricao.service';
import { InscricaoData } from '../../datas/InscricaoData';
import { gray } from '@ant-design/colors';
import { Button, Form, Input, Modal } from 'antd';
import { SelectEnum } from './SelectEnum';
import { MyEnum, enumOptions } from './enumOption';
import { buscarIdPorCpf } from '../../services/user.service';
...
export const ButtonCreateInscricao: React.FC<Props> = ({
    setData: setData,
