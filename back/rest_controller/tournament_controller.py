...
#
# from model.Enums import tipo_torneio_enum
# from model.torneio_model import TorneioModel
# from service.tournament_service import TorneioService
#
# TournamentController = Blueprint('TournamentController', __name__)
# tournament_service = TorneioService()
#
# # create a new tournament
# @TournamentController.route('/', methods=['POST', 'OPTIONS'])
...
#
# # get all torunaments
# @TournamentController.route('/', methods=['GET'])
# def get_tournaments():
...
# @TournamentController.route('/<int:tournament_id>', methods=['GET'])
...
#
# # update a tournament
# @TournamentController.route('/<int:tournament_id>', methods=['PUT'])
...
#
# # delete a tournament
# @TournamentController.route('/<int:tournament_id>', methods=['DELETE'])
